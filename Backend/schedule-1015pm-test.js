...
async function scheduleTwitterPost() {
  try {
    console.log("🚀 Scheduling Twitter post for 10:15pm...");
    ...
    // Schedule the post for 10:15pm today
    const today = new Date();
    const scheduleTime = new Date(today);
    scheduleTime.setHours(22, 15, 0, 0); // 10:15 PM
    ...
    const { data: scheduledPost, error: postError } = await supabase
      ...
      .insert({
        ...
        content:
          "🚀 Testing automated Twitter scheduling for 10:15pm! This post was scheduled via my custom API. #automation #twitter #scheduling",
    ...
    console.log("✅ Successfully scheduled Twitter post for 10:15pm!");
