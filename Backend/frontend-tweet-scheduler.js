...
async function scheduleTwitterPost() {
  ...
  try {
    ...
    await page.waitForSelector(
      'textarea, input[placeholder*="content"], input[placeholder*="post"]',
      { timeout: 10000 }
    );
    ...
    const tweetContent =
      "🕐 4:00 PM Tweet from Frontend! 🚀 Successfully scheduled through the web interface! #AutomationSuccess #FrontendScheduling";
    ...
    await page.screenshot({
      path: "tweet-scheduled-confirmation.png",
      fullPage: true,
    });
